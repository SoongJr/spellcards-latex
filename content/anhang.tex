...
\section{Interview mit Prof.~Dr.~\glsentryname{Google}} % need to use \glsentryname to refer to glossary terms in chapter/section headers! For acronyms you might want \glsentryshort instead.
\begin{faq}
