...
class SpellCardGeneratorApp:
    ...
    def _setup_controls_ui(self):
        ...
        self.progress_bar = ttk.Progressbar(
            self.main_window.progress_frame,
    ...
    def _load_initial_data(self):
        ...
        try:
            ...
            self.class_manager.setup_class_sections(
                self.data_loader.character_classes
            )
            self.status_var.set(
    ...
    def generate_cards(self):
        ...
        try:
            ...
            if generated_files:
                ...
                result_msg += f"\\n\\nAdd \\input{{}} statements to the corresponding .tex files to include them in the document."
            ...
            self.dialog_manager.show_error("Unexpected Error", f"An unexpected error occurred: {e}")
            self.status_var.set("Error occurred")
        finally:
