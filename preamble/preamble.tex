...
\usepackage{scrlayer-scrpage}   % for advanced page numbering
\usepackage{emptypage}          % do not print useless footer on empty pages (will not be necessary after moving to KOMA)
