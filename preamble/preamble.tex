...
\AtBeginDocument{
    ...
    % Ultimately we want numbers to restart with each spell, AND show the total number of pages for this spell, but I didn't get that to work using code modified from \url{https://tex.stackexchange.com/a/469585/52439}
}
